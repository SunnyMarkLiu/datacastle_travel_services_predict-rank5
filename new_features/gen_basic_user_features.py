...
def main():
    feature_name = 'basic_user_features'
    ...
    train_user.to_csv(Configure.new_cleaned_path + 'cleaned_userProfile_train.csv', index=False, columns=train_user.columns)
    test_user.to_csv(Configure.new_cleaned_path + 'cleaned_userProfile_test.csv', index=False, columns=test_user.columns)
    ...
    data_utils.save_new_features(train_user, test_user, features_name=feature_name)
