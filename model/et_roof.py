...
def main():
    ...
    train_pred_df.to_csv(Configure.base_path + "/ensemble/et_roof{}_predict_train.csv".format(roof_flod), index=False,
    ...
    test_pred_df.to_csv(Configure.base_path + "/ensemble/et_roof{}_predict_test.csv".format(roof_flod), index=False,
                        columns=['userid', 'et_orderType'])
