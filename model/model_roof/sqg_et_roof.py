...
def main(options):
    ...
    predict_feature = 'sqg_et_predict_roof_fold{}_n_estimators{}_min_samples_leaf{}_min_samples_split{}_seed{}'.format(
    ...
    train_pred_df.to_csv("./ensemble/train/sqg_et_roof{}_predict_train_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature), index=False,
    ...
    test_pred_df.to_csv("./ensemble/test/sqg_et_roof{}_predict_test_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature), index=False,
                        columns=['userid', predict_feature])
