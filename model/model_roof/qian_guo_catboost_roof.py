...
def main(options):
    ...
    train_pred_df.to_csv("./ensemble/train/catboost/sqg_cat_roof{}_predict_train_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature),
    ...
    test_pred_df.to_csv("./ensemble/test/catboost/sqg_cat_roof{}_predict_test_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature),
                        index=False, columns=['userid', predict_feature])


if __name__ == "__main__":
    print("========== qian guo catboost run out of fold ==========")
    parser = OptionParser()
