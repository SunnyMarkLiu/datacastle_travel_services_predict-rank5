...
def main(options):
    ...
    train_pred_df.to_csv("./ensemble/level2/level2_xgb_predict_train_cv{}.csv".format(mean_cv_scores),
    ...
    test_pred_df.to_csv("./ensemble/level2/level2_xgb_predict_test_cv{}.csv".format(mean_cv_scores),
                        index=False, columns=['userid', predict_feature])


if __name__ == "__main__":
    print("========== level-2 xgboost run out of fold ==========")
    parser = OptionParser()
