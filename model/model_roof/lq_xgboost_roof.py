...
def main(options):
    ...
    train_pred_df.to_csv(Configure.base_path + "ensemble/train/lq_xgb_roof{}_predict_train_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature),
    ...
    test_pred_df.to_csv(Configure.base_path + "ensemble/test/lq_xgb_roof{}_predict_test_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature),
                        index=False, columns=['userid', predict_feature])
