...
def main(options):
    ...
    train_pred_df.to_csv(Configure.base_path + "ensemble/train/sqg_xgb_roof{}_predict_train_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature),
    ...
    test_pred_df.to_csv(Configure.base_path + "ensemble/test/sqg_xgb_roof{}_predict_test_cv{}_{}.csv".format(roof_flod, mean_cv_scores, predict_feature),
                        index=False, columns=['userid', predict_feature])


if __name__ == "__main__":
    print("========== qian guo xgboost run out of fold ==========")
    parser = OptionParser()
